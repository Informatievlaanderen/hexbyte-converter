...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.Utilities.HexByteConvertor")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.Utilities.HexByteConvertor")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Utilities.HexByteConvertor")
